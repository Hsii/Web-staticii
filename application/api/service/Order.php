...
//        return $message->sendDeliveryMessage($order, $jumpPage);
    ...
    private function getOrderStatus()
    {
        $status = [
            ...
            'orderPrice' => 0,
            'totalCount' => 0,
            'pStatusArray' => []    //保存订单里所有商品信息,历史订单
        ];
//        is_array($this->oProducts)?$this->oProducts:$this->oProducts = array();
...
//    private function getProductsByOrder($oProducts=[])
    {
        // 商品id号
        $oPIDs = [];
//        is_array($oProducts)?$oProducts:$oProducts = array();
